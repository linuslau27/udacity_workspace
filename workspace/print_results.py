    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if (sum(results_dic[key][3:] == 1)):
                #((results_dic[key][3] == 1) & (results_dic[key][4] == 0)) | ((results_dic[key][3] == 0) & (results_dic[key][4] == 1))
                print("Disagreeing Labels: {:>26}    Disagreeing Classifiers: {:>30}".format(results_dic[key][0], results_dic[key][1]))
